...
<!--[if (gt IE 9)|!(IE)]><!--><html lang="en"><!--<![endif]-->
    ...
    <body class="contact_page">
            ...
            <div class="container-fluid">
                <div class="row top_menu_area">
                    <div class="col-xs-12 col-sm-3">
                        ...
                        <div class="logo_area">
                            <a href="index.html">
                                <img src="img/logo.svg" alt="theme logo" class="main_logo svg">
                            </a>
                        </div>
                        <!-- END LOGO AREA -->
                    </div>
                    <div class="col-xs-12 col-sm-9">
                        ...
                        <nav class="navbar-collapse collapse in">
                            <ul class="nav navbar-nav navbar-right menu">
                                ...
                                <li class="smoth-scroll">
                                    <a data-hover="Services" href="#">Services</a>
                                </li>
                                <li class="smoth-scroll">
                                    <a data-hover="ABOUT" href="#">About</a>
                                </li>
                                <li class="smoth-scroll">
                                    <a data-hover="Portfolio" href="protfolio-1.html">Portfolio</a>
                                    <ul class="sub_menu">
                                        <li class="waves-effect waves">
                                ...
                                <li class="smoth-scroll">
                                    <a data-hover="Blog" href="blog_grid.html">Blog</a>
                                    <ul class="sub_menu">
                                        <li class="waves-effect waves">
                        ...
                        <nav class="mobile_menu hidden">
                            <ul>
                                ...
                                <li>
                                    <a href="protfolio-1.html">Portfolio</a>
                                    <ul>
                                        <li>
                                            <a href="protfolio-1.html">Protfolio 1</a>
                                        </li>
        ...
        <!-- ====START CONTACT AREA==== -->
        <section class="mail_sent_area section-padding">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <?php
                            if(isset($_POST['submit_btn'])){
                                $to = 'html@themeebit.com'; // this is your Email address
                                $from = $_POST['your_mail']; // this is the sender's Email address
                                $subject = 'Chicago Web App contact form mail';
                                $subject2 = 'Copy of your ' . $subject;
                                $message = 'Here is a copy of your message:' . $_POST['your_text'] . 'Name: ' . $_POST['your_name'];
                                $headers = 'From:' . $from;
                                $headers2 = 'From:' . $to;
                                ...
                                echo '<div class="text-center thank-you">
                                        ...
                                        <h1>Mail Sent. Thank you, we will contact you shortly.</h1>
                                    </div>';
                            }
                        ?>
                    </div>
